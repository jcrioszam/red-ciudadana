...
Usando la cadena de conexión completa de Railway
"""
...
def conectar_bd():
    """Conectar a la base de datos PostgreSQL usando la cadena de conexión completa"""
    try:
...
def main():
    """Función principal"""
    print("🚀 IMPORTACIÓN DIRECTA DEL PADRÓN ELECTORAL")
    print("=" * 50)
